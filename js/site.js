const translations = {
  ...
  ES: {
    ...
    roadmapTitle: "Del primer disparo a un mundo reconstruido.",
    phase1: "FASE 1 — PROTOTIPO",
    phase1Text: "Física principal, primeros niveles, LUNKI y DUSTERS.",
    phase2: "FASE 2 — MUNDO 1",
    phase2Text: "Ruinas de Terra Classic, progresión y primeros jefes.",
    phase3: "FASE 3 — PULIDO",
    phase3Text: "Sonido, efectos visuales, animaciones, interfaz y progresión.",
    phase4: "FASE 4 — LANZAMIENTO",
    phase4Text: "Lanzamiento, estadísticas, publicidad y seguimiento transparente de las quemas.",
  ...
  DE: {
    ...
    roadmapEyebrow: "ROADMAP",
    roadmapTitle: "Vom ersten Schuss zu einer wiederaufgebauten Welt.",
    phase1: "PHASE 1 — PROTOTYP",
    phase1Text: "Grundlegende Physik, erste Level, LUNKI und DUSTERS.",
    phase2: "PHASE 2 — WELT 1",
    phase2Text: "Ruinen von Terra Classic, Fortschritt und erste Bosse.",
    phase3: "PHASE 3 — FEINSCHLIFF",
    phase3Text: "Sound, visuelle Effekte, Animationen, Benutzeroberfläche und Fortschrittssysteme.",
    phase4: "PHASE 4 — START",
    phase4Text: "Veröffentlichung, Statistiken, Werbung und transparente Burn-Berichte.",
  ...
  PT: {
    ...
    roadmapTitle: "Do primeiro disparo a um mundo reconstruído.",
    phase1: "FASE 1 — PROTÓTIPO",
    phase1Text: "Física principal, primeiros níveis, LUNKI e DUSTERS.",
    phase2: "FASE 2 — MUNDO 1",
    phase2Text: "Ruínas de Terra Classic, progressão e primeiros bosses.",
    phase3: "FASE 3 — POLIMENTO",
    phase3Text: "Som, efeitos visuais, animações, interface e sistemas de progressão.",
    phase4: "FASE 4 — LANÇAMENTO",
    phase4Text: "Lançamento, estatísticas, publicidade e acompanhamento transparente dos burns.",
